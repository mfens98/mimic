...
from mimic.canned_responses.glance import get_images, get_image_schema, get_versions
...
class GlanceMock(object):
    ...
    @app.route('/v2/<string:tenant_id>/versions', methods=['GET'])
    def list_versions(self, request, tenant_id):
        """
        Returns a version for the glance client. Will just list v2
        """
